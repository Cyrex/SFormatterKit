...
//
//  File name: STextFormatterTests.m
...
@interface STextFormatterTests : XCTestCase

@end

@implementation STextFormatterTests
- (void)setUp {
    [super setUp];
...
- (void)testSplitStringUsingBlocks {
    ...
    XCTAssert([testString isEqualToString:@"1234 1234 1234 1234"],
              @"NSString+STextFormatter can't split string using blocks");
...
- (void)testSplitStringWithPrefixUsingBlocks {
    ...
    XCTAssert([testString isEqualToString:@"S1234 1234 1234 1234"],
              @"NSString+STextFormatter can't split string with prefix using blocks");
...
- (void)testCheckDateString {
    ...
    XCTAssert([testString isEqualToString:@"1995/"],
              @"NSString+STextFormatter can't check date string");
    ...
    XCTAssert([testString isEqualToString:@"1995/03/"],
              @"NSString+STextFormatter can't check date strin");
