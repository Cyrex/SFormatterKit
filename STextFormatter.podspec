#
# Be sure to run `pod lib lint STextFormatter.podspec' to ensure this is a
...
A simple library for formatting your input content when you are typing.
  ...
  s.source           = { :git => 'https://github.com/Cyrex/STextFormatter.git', :tag => s.version.to_s }
